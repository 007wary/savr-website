      ...
      <main style={{ paddingTop: '70px', minHeight: '100vh', background: 'var(--bg-primary)' }}>
        <section style={{ padding: '80px 24px' }}>
          <div style={{ maxWidth: '640px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '13px', fontWeight: '600', color: 'var(--color-primary)', letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '12px' }}>Account</p>
            <h1 style={{ fontSize: 'clamp(28px, 4vw, 48px)', fontWeight: '800', color: 'var(--text-primary)', marginBottom: '16px' }}>Delete Your Account</h1>
            ...
            <div style={{ marginBottom: '48px' }}>
              <h2 style={{ fontSize: '20px', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '20px' }}>How to delete your account</h2>
              <p style={{ fontSize: '15px', color: 'var(--text-muted)', marginBottom: '16px' }}>You can delete your account directly from the app:</p>
              {[
                'Open the Savr app',
                'Go to Settings tab',
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '16px', marginBottom: '12px' }}>
                  ...
                  <p style={{ fontSize: '15px', color: 'var(--text-muted)', lineHeight: '1.6', margin: '4px 0 0' }}>{step}</p>
                </div>
              ))}
            </div>
            ...
            {/* Email button */}
            <div style={{ marginBottom: '48px' }}>
              <h2 style={{ fontSize: '20px', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '16px' }}>Request data deletion by email</h2>
              ...
              <a href="mailto:007mwnswrangwary@gmail.com?subject=Delete My Savr Account&body=Please delete my Savr account and all associated data. My registered email is: [your email]" style={{ display: 'inline-block', background: 'var(--color-primary)', color: '#ffffff', textDecoration: 'none', padding: '13px 28px', borderRadius: '10px', fontSize: '15px', fontWeight: '600' }}>
            ...
            {/* What gets deleted */}
            <div style={{ marginBottom: '48px' }}>
              <h2 style={{ fontSize: '20px', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '20px' }}>What data gets deleted</h2>
              {[
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                  ...
                  <p style={{ fontSize: '15px', color: item.deleted ? '#f87171' : 'var(--text-muted)', margin: 0 }}>{item.label}</p>
                </div>
              ))}
            </div>
            ...
            <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: '12px', padding: '24px' }}>
              <h2 style={{ fontSize: '18px', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '12px' }}>Processing time</h2>
              <p style={{ fontSize: '15px', color: 'var(--text-muted)', lineHeight: '1.7', margin: 0 }}>
                We will process your deletion request within <strong style={{ color: 'var(--text-primary)' }}>30 days</strong> of receiving it. You will receive a confirmation email once your account has been deleted.
              </p>
            </div>
